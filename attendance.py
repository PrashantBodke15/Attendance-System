...
class Attendance:
    def __init__(self, root):
        ...
        #first image
        img=Image.open(r"D:\Downloads\attendance system\project images\image4.jpg")
        ...
        #second image
        img1=Image.open(r"D:\Downloads\attendance system\project images\Image5.jpg")
       ...
       # bg image
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="dark green",fg="white")
      ...
      #left label frame 
        ...
        # roll
        rollLabel=Label(left_inside_frame,text="Roll:",bg="white",font="comicsasns 11 bold")
        ...
        # name
        nameLabel=Label(left_inside_frame,text="Name:",bg="white",font="comicsasns 11 bold")
        ...
        # department 
        depLabel=Label(left_inside_frame,text="Department:",bg="white",font="comicsasns 11 bold")
        ...
        # time
        timeLabel=Label(left_inside_frame,text="Time:",bg="white",font="comicsasns 11 bold")
        ...
        #date 
        dateLabel=Label(left_inside_frame,text="Date:",bg="white",font="comicsasns 11 bold")
        ...
        # attendance
        attendanceLabel=Label(left_inside_frame,text="Atttendance Status:",bg="white",font="comicsasns 11 bold")
        attendanceLabel.grid(row=3,column=0)

        self.attern_status=ttk.Combobox(left_inside_frame,width=20,textvariable=self.var_atten_attendance,font="comicsansns 11 bold",state="readonly")
        self.attern_status["values"]=("status","present","absent")
        self.attern_status.grid(row=3,column=1,pady=8)
