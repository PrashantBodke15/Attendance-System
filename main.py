...
class Face_Recognization_system:
    def __init__(self,root):
        ...
        self.root.title("face Recognition System")
         ...
         #first image
        img=Image.open(r"D:\Downloads\attendance system\project images\clg1.jpg")
      ...
      #second image
        img1=Image.open(r"D:\Downloads\attendance system\project images\face.jpg")
        ...
        #third image
        img2=Image.open(r"D:\Downloads\attendance system\project images\clg2.jpg")
        img2=img2.resize((520,150),Image.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)

        f_lbl=Label(self.root,image=self.photoimg2)
        f_lbl.place(x=1000,y=0,width=520,height=130)


        #bg image
        img3=Image.open(r"D:\Downloads\attendance system\project images\bg.jpg")
        ...
        #student button
        img4=Image.open(r"D:\Downloads\attendance system\project images\student.jpg")
  ...
  #Detect face button
        img5=Image.open(r"D:\Downloads\attendance system\project images\face2.jpg")
        ...
        #Attendance button
        img6=Image.open(r"D:\Downloads\attendance system\project images\attendence.jpg")
        ...
        #help desk button
        img7=Image.open(r"D:\Downloads\attendance system\project images\help.jpg")
        ...
        #train button
        img8=Image.open(r"D:\Downloads\attendance system\project images\train.jpg")
        ...
        #photos face button 
        img9=Image.open(r"D:\Downloads\attendance system\project images\photos.jpg")
        ...
        img10=Image.open(r"D:\Downloads\attendance system\project images\developer.jpg")
        ...
        b1.place(x=800,y=580,width=220,height=40)
         ...
         #  Exitbutton 
        img11=Image.open(r"D:\Downloads\attendance system\project images\Exit.jpg")
    ...
    def iExit(self):
        self.iExit=tkinter.messagebox.askyesno("face Recognition","are tou sure this project",parent=self.root)
        if self.iExit>0:
            self.root.destroy()
        else:
            return
